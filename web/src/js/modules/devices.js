...
export function devicesModule() {
    return {
        ...
        getSignalLevel(rssi, snr) {
            if (!rssi && !snr) return 0;
            if (rssi > -70 && snr > 10) return 3;
            if (rssi > -85 && snr > 5) return 2;
            return 1;
        },
        ...
        isLedPresetActive(pr, pg, pb, vur, vug, vub, offr, offg, offb) {
            return this.ledColors.program.r === pr &&
                   this.ledColors.program.g === pg &&
                   this.ledColors.program.b === pb &&
                   this.ledColors.preview.r === vur &&
                   this.ledColors.preview.g === vug &&
                   this.ledColors.preview.b === vub &&
                   this.ledColors.off.r === offr &&
                   this.ledColors.off.g === offg &&
                   this.ledColors.off.b === offb;
        }
    };
}
